...
This application is tailored to his specific needs and uses additional middleware to protect the users. The app uses Google OAuth passport strategy for managing user authentication. 
